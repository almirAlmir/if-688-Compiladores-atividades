...
import task02RPNStackerSimplescanning.ExpressionEvaluator;
import task02RPNStackerSimplescanning.Token;
...
public class Main {
	static String str = "src/task02RPNStackerSimplescanning/Calc1.stk";
